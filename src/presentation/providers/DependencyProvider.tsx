...
export function DependencyProvider({
  ...
  useEffect(() => {
    ...
    const addPlayerUseCase = new AddPlayerUseCase(playerRepository, teamRepository);
    const updatePlayerUseCase = new UpdatePlayerUseCase(playerRepository);
    const removePlayerUseCase = new RemovePlayerUseCase(playerRepository, teamRepository);
